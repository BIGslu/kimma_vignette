...
The order of your variable levels is important for results interpretation. Here, our `virus` variable is a factor with order "none", "HRV". This means positive estimates are genes that are UP with HRV infection.
